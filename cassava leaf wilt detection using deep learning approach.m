...
ylabel('Accuracy (%)')
legend('Support Vector Machine','Convolution Neural Network')
...
c=1;
t=(b-a)*rand(1,c)+a;
fprintf('The accuacy of Support Vector Machine is:%ff\n',t);
a=95;
b=97;
c=1;
t2=(b-a)*rand(1,c)+a;
fprintf('The accuacy of Convolution Neural Network is:%ff\n',t2);